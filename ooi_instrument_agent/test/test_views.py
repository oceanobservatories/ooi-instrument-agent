...
class ViewTest(unittest.TestCase):
    ...
    @mock.patch('ooi_instrument_agent.views.list_drivers')
    def test_list_drivers2(self, mocked):
        mocked.return_value = ["RS10ENGC-XX00X-00-SPKIRA001", "RS10ENGC-XX00X-00-TMPSFA001"]
        # make the request
